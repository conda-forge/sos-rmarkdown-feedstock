...
Once the `conda-forge` channel has been enabled, `sos-rmarkdown` can be installed with:

```
conda install sos-rmarkdown
```

It is possible to list all of the versions of `sos-rmarkdown` available on your platform with:
